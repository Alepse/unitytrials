            ...
            <CardContent className="p-8">
              <form onSubmit={handleSearch} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Recruitment Status</label>
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="not-yet">Not Yet Recruiting</SelectItem>
                        <SelectItem value="completed">Completed Recruitment</SelectItem>
                  ...
                  <div>
                    ...
                    <Input placeholder="City, State, or ZIP code" className="border-slate-300 rounded-xl" />
                  </div>
                  
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Trial Phase</label>
                    <Select>
                      <SelectTrigger className="border-slate-300 rounded-xl">
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-16">
            <Button variant="outline" size="lg" className="border-teal-200 text-teal-600 hover:bg-teal-50 px-8 py-4 rounded-xl">
              <Search className="w-5 h-5 mr-2" />
              Load More Trials
            </Button>
          </div>
